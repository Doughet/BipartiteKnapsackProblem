...
public class TruckOptimisationDP {
    ...
    public TruckOptimisationDP(XSSFWorkbook workbook, String sheetName){
    ...
    TruckOptimisationDP.ResultBundle getResultBundle(){
        return new TruckOptimisationDP.ResultBundle(infoArray, valuesArray, P, N);
    }
